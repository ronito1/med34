...
<body>
               ...
               <div class="row">
                  <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                     <div class="logo-wrapper3">
                        <a href="javascript:;"><img src="images/home3/logo4.png" alt="img"></a>
                     </div>
                  </div>
         ...
         <div class="carousel-inner">
            <div class="carousel-item active">
               <div class="container">
                  ...
                  <div class=" d-flex justify-content-center align-items-center">
                     <a href="javascript:;" class="button-btn bg-yellow mt-4 me-4">book now
                        <span><i class="fas fa-angle-double-right"></i></span>
                     </a>
                     <div class="mt-4 ps-rel">
                        <button type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                           <span class="wrapper">
                              <span class="waves-block">
                                 <span class="waves wave-1"></span>
                                 <span class="waves wave-2"></span>
                                 <span class="waves wave-3"></span>
                              </span>
                           </span>
                           <img src="images/home3/video-icon.png" alt="img" class="ps-rel">
                        </button>
                        <!-- Modal -->
            ...
            <div class="carousel-item">
               <div class="container">
                  ...
                  <div class=" d-flex justify-content-center align-items-center">
                     <a href="appoinment.html" class="button-btn bg-yellow mt-4 me-4">book now
                        <span><i class="fas fa-angle-double-right"></i></span>
                     </a>
                     <a href="javascript:;" class="mt-4 ps-rel">
                        <div class="wrapper">
   ...
   <!-- index 03 page service section  start -->
   ...
   <!-- index 03 page service section  end-->
   <!-- about section start -->
   <div class="image-about-wrapper about-main-wrapper3 ptb-100 pt-0 float_left">
      <div class="container ">
         <div class="row ">
            <div class="col-lg-6 col-md-12 col-sm-12 col-12">
               <div class="about-content ">
                  <h6 class="home1-section-heading1 text-start text-color-change3">About Us</h6>
                  ...
                  <a href="about-us.html" class="button-btn bg-yellow mt-4">read more
                     <span><i class="fas fa-angle-double-right"></i></span>
                  </a>
               </div>
            </div>
            <div class="col-lg-6 col-md-12">
               <div class="image-section ps-rel animate-top-y">
                  <img src="images/home3/about-image3.png" class="img-fluid d-xl-block d-lg-block d-none" alt="img">
               </div>
            </div>
         </div>
      </div>
   ...
   <div class="services-main-wrapper service-slider-wrappe3 float_left">
      <div class="container">
         <div class="row">
            <div class="col-lg-12 col-md-12">
               <div class="sb-service-section">
                  <div class="d-xl-flex d-lg-flex justify-content-between d-md-block d-block">
                     <div>
                        <h6 class="home1-section-heading1 text-start text-color-change3">Our Services</h6>
                        <h5 class="home1-section-heading2 text-start">Special High-quality Services</h5>
                     </div>
                     <div>
                        <a href="service.html" class="button-btn bg-yellow mt-4">read more
                           <span><i class="fas fa-angle-double-right"></i></span>
                        </a>
                     </div>
                  </div>
                        ...
                        <div class="item ">
                           <div class="slider-content3">
                              <div class="icon ">
                                 ...
                                 <img src="images/home3/one1.png" alt="img">
                              </div>
                              <h6 class="pt-4">Covid-19</h6>
                              <p class="text-start">It is a long established fact a
                                 will be distracted by the read
                                 content of a page.
                              </p>
                              <a href="service.html" class="text-color-change3 mt-3 d-inline-block">Read More
                                 ></a>
                           </div>
                        </div>
                        <div class="item ">
                           <div class="slider-content3">
                              <div class="icon bg-green">
                                 ...
                                 <img src="images/home3/one2.png" alt="img">
                              </div>
                              <h6 class="pt-4">Full Stathoscope</h6>
                              <p class="text-start">It is a long established fact a
                                 will be distracted by the read
                                 content of a page.
                              </p>
                        ...
                        <div class="item ">
                           <div class="slider-content3">
                              <div class="icon bg-yellow">
                                 ...
                                 <img src="images/home3/one3.png" alt="img">
                              </div>
                              <h6 class="pt-4">Heart Specialest</h6>
                              <p class="text-start">It is a long established fact a
                                 will be distracted by the read
                                 content of a page.
                              </p>
                        ...
                        <div class="item ">
                           <div class="slider-content3">
                              <div class="icon bg-pink">
                                 ...
                                 <img src="images/home3/one4.png" alt="img">
                              </div>
                              <h6 class="pt-4 ">Psychiatry</h6>
                              <p class="text-start">It is a long established fact a
                                 will be distracted by the read
                                 content of a page.
                              </p>
      ...
      <div class="container">
         <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
               <div class="mb-5">
                  <h6 class="home1-section-heading1 text-color-change3">Our Services</h6>
                  <h5 class="home1-section-heading2 ">Sefety And Comfortable</h5>
               </div>
            </div>
            ...
            <div class="col-lg-12 col-md-12 col-12">
               <div class="text-center mt-3">
                  <a href="gallery.html" class="button-btn bg-yellow mt-4">view gallery
                     <span><i class="fas fa-angle-double-right"></i></span>
                  </a>
               </div>
            </div>
   ...
   <!-- index 03 page about gallery section start -->
   <div class="about-gallery-main3 float_left">
      <div class="container">
         <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
               <h6 class="home1-section-heading1 text-color-yellow">Our Services</h6>
               <h5 class="home1-section-heading2 text-color-white pt-1 pb-3">We care about everything what you want
               </h5>
               <p class="text-color-white text-center">It is a long established fact that a reader will be
                  distracted by the readable content of<br>
                  a page when looking at its layout. The point of using Lorem Ipsum.
               </p>
               <div class=" d-flex justify-content-center align-items-center">
                  <a href="about-us.html" class="button-btn bg-yellow mt-5 me-4">about us
                     <span><i class="fas fa-angle-double-right"></i></span>
                  </a>
                  <div class="mt-5 ps-rel">
                     <div data-bs-toggle="modal" data-bs-target="#staticBackdrop1">
                        ...
                        <img src="images/home3/video-icon2.png" alt="img" class="ps-rel">
                     </div>
   ...
   <!-- index 03 page about gallery section end -->
   <!-- index 03 page team section start -->
   <div class="our-team-main3 float_left ptb-100">
      <div class="container">
         <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
               <div class="mb-5">
                  <h6 class="home1-section-heading1 text-color-change3">Our Team</h6>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 col-12">
               <section>
                  <div class="sb-team3">
                     <a href="dr-single.html"><img src="images/home3/team-img31.jpg" class="w-100" alt="img"></a>
                  </div>
                  <div class="team-box">
                     <div class="icon">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 col-12">
               <section>
                  <div class="sb-team3">
                     <a href="dr-single.html"><img src="images/home3/team-img34.jpg" class="w-100" alt="img"></a>
                  </div>
                  <div class="team-box">
                     <div class="icon">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 col-12">
               <section>
                  <div class="sb-team3">
                     <a href="dr-single.html"><img src="images/home3/team-img32.jpg" class="w-100" alt="img"></a>
                  </div>
                  <div class="team-box">
                     <div class="icon">
                        <h6>Dr. Donna Sisk</h6>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 col-12">
               <section>
                  <div class="sb-team3">
                     <a href="dr-single.html"><img src="images/home3/team-img33.jpg" class="w-100" alt="img"></a>
                  </div>
                  <div class="team-box">
                     <div class="icon">
                        <h6>Dr. Joshua Carter</h6>
   ...
   <!-- index 03 page team section end -->
   <!--index 03 page  counter section start -->
   <div class="counter-main-wrapper counter-main3 float_left">
      <div class="container">
         <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
               <div class="count-up ">
                  <div class="counter-icon bg-border-yellow">
                  ...
                  <h3 class="counter-count text-color-black">4500</h3>
                  <p class="text-color-black">Happy Patients</p>
               </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
               <div class="count-up">
                  ...
                  <h3 class="counter-count text-color-black">200</h3>
                  <p class="text-color-black">Hospital Rooms</p>
               </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
               <div class="count-up">
                  ...
                  <h3 class="counter-count text-color-black">450</h3>
                  <p class="text-color-black">Award Win</p>
               </div>
            </div>
            <div class="col-lg-3  col-md-3 col-sm-12 col-xs-12">
               <div class="count-up">
                  ...
                  <h3 class="counter-count text-color-black">20</h3>
                  <p class="text-color-black">Ambulance</p>
               </div>
            </div>
         </div>
      </div>
   </div>
   <!--index 03 page  counter section end -->
   <!-- index 03 page our blog section start -->
   <div class="blog-main-wrapper blog-main3">
      <div class="container">
         <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
               <div class="">
                  <h6 class="home1-section-heading1 text-color-change3">Our Blog</h6>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-12">
               <div class="blog-box">
                  <div class="img-icon">
                     ...
                     <p class="bg-yellow text-center">08<br>
                        july
                     </p>
                  </div>
                  <div class="blog-content">
                     ...
                     <ul>
                        <li><a href="javascript:;"><i class="far fa-user text-yellow"></i> by
                              John Doe</a>
                        </li>
                        <li><a href="javascript:;"><i class="far fa-comments text-yellow"></i>Comments 02
                           </a>
                        </li>
                     </ul>
                     <p>It is a long established fact that a reader will be
                     ...
                     <a href="blog-single.html" class="r-btn text-yellow">Read More</a>
                  </div>
               </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12 col-12">
               <div class="blog-box">
                  <div class="img-icon">
                     ...
                     <div class="img-overlay"></div>
                     <p class="bg-yellow text-center">20<br>
                        july
                     </p>
                  </div>
                  <div class="blog-content">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-12">
               <div class="blog-box">
                  <div class="img-icon">
                     ...
                     <div class="img-overlay"></div>
                     <p class="bg-yellow text-center">28<br>
                        july
                     </p>
                  </div>
                  <div class="blog-content">
   ...
   <!-- index 03 page our blog section end -->
   <!-- index 03 page testimonial section start -->
   <div class="testimonial-main3 float_left ptb-100">
      <div class="container">
         <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
               <h6 class="home1-section-heading1 text-color-change3 text-start">Our Blog</h6>
               <h5 class="home1-section-heading2 text-start text-color-white mb-5">Our Latest News</h5>
            </div>
            <div class="test-slider">
               <div class="owl-carousel owl-theme">
                  <div class="item">
                     <p class="text-color-white">Lorem Ipsum is simply dummy text of the printing and typesetting
                     ...
                     <div class="d-flex flex-start align-items-center mt-4">
                        <img src="images/home3/test-team1.png" class="w-auto" alt="img">
                        <h6 class="ps-4"><a href="javascript:;" class="text-color-change3">- Akshay H.</a></h6>
                     </div>
                     <span><i class="fas fa-quote-left"></i></span>
                  </div>
                  <div class="item">
                     <p class="text-color-white">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors.
                     </p>
                     <div class="d-flex flex-start align-items-center mt-4">
                        <img src="images/home3/test-team1.png" class="w-auto" alt="img">
                        <h6 class="ps-4"><a href="javascript:;" class="text-color-change3">- Joshua Carter</a></h6>
                     </div>
                     <span><i class="fas fa-quote-left"></i></span>
                  </div>
                  <div class="item">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 col-12">
               <div class="sb-footer-section">
                  <div class="footer-logo">
                     <a href="javascript:;"><img src="images/home3/f-logo3.png" alt="img"></a>
                  </div>
                  <ul>
            ...
            <div class="col-lg-2 col-md-6 col-sm-12 col-12">
               <div class="links">
                  ...
                  <ul>
                     ...
                     <li><a href="javascript:;"><i class="fas fa-angle-right"></i>Our Mission</a></li>
                     <li><a href="javascript:;"><i class="fas fa-angle-right"></i>Our Approch</a></li>
                     <li><a href="javascript:;"><i class="fas fa-angle-right"></i>Our History</a></li>
                     <li><a href="javascript:;"><i class="fas fa-angle-right"></i>Achivments</a></li>
                     <li><a href="javascript:;"><i class="fas fa-angle-right"></i>Careers</a></li>
                     <li><a href="javascript:;"><i class="fas fa-angle-right"></i>Appoinments</a></li>
                  </ul>
               </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12 col-12">
